...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      19: { start: 17, end: 44, title: 'Write and Identify Equivalent Expressions' },
      20: { start: 45, end: 56, title: 'Understand Solutions of Equations' },
      21: { start: 57, end: 84, title: 'Write and Solve One-Variable Equations' },
      22: { start: 85, end: 106, title: 'Analyze Two-Variable Relationships' },
      ...
      28: { start: 203, end: 224, title: 'Solve Problems in the Coordinate Plane' },
      29: { start: 241, end: 252, title: 'Understand Statistical Questions and Data Distributions' },
      30: { start: 253, end: 274, title: 'Use Dot Plots and Histograms to Describe Data Distributions' },
      31: { start: 275, end: 296, title: 'Interpret Median and Interquartile Range in Box Plots' },
      32: { start: 297, end: 318, title: 'Interpret Mean and Mean Absolute Deviation' },
      33: { start: 319, end: 334, title: 'Use Measures of Center and Variability to Summarize Data' },
    },
    'RCM07_NA_SW_V1': {
