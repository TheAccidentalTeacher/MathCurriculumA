...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      15: { start: 41, end: 52, title: 'Understand Rate Concepts' },
      16: { start: 53, end: 80, title: 'Use Unit Rates to Solve Problems' },
      17: { start: 81, end: 92, title: 'Understand Percents' },
      18: { start: 93, end: 114, title: 'Use Percents to Solve Problems' },
      19: { start: 131, end: 158, title: 'Write and Identify Equivalent Expressions' },
      20: { start: 159, end: 170, title: 'Understand Solutions of Equations' },
      21: { start: 171, end: 198, title: 'Write and Solve One-Variable Equations' },
      22: { start: 199, end: 220, title: 'Analyze Two-Variable Relationships' },
      23: { start: 237, end: 248, title: 'Understand Positive and Negative Numbers' },
      24: { start: 249, end: 264, title: 'Order Positive and Negative Numbers' },
      25: { start: 265, end: 276, title: 'Understand Absolute Value' },
      26: { start: 277, end: 304, title: 'Write and Graph One-Variable Inequalities' },
      27: { start: 305, end: 316, title: 'Understand the Four-Quadrant Coordinate Plane' },
      28: { start: 317, end: 338, title: 'Solve Problems in the Coordinate Plane' },
      29: { start: 355, end: 366, title: 'Understand Statistical Questions and Data Distributions' },
      30: { start: 367, end: 388, title: 'Use Dot Plots and Histograms to Describe Data Distributions' },
      31: { start: 389, end: 410, title: 'Interpret Median and Interquartile Range in Box Plots' },
      32: { start: 411, end: 432, title: 'Interpret Mean and Mean Absolute Deviation' },
      33: { start: 433, end: 448, title: 'Use Measures of Center and Variability to Summarize Data' },
    },
    'RCM07_NA_SW_V1': {
