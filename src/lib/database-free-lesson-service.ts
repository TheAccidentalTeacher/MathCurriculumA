...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      19: { start: 3, end: 18, title: 'Find the Area of a Parallelogram' },
      20: { start: 19, end: 40, title: 'Find the Area of Triangles and Other Polygons' },
      21: { start: 41, end: 62, title: 'Use Nets to Find Surface Area' },
      22: { start: 63, end: 84, title: 'Work with Algebraic Expressions' },
      23: { start: 85, end: 106, title: 'Write and Evaluate Expressions with Exponents' },
      24: { start: 107, end: 144, title: 'Find Greatest Common Factor and Least Common Multiple' },
      25: { start: 145, end: 166, title: 'Add, Subtract, and Multiply Multi-Digit Decimals' },
      26: { start: 167, end: 194, title: 'Divide Whole Numbers and Multi-Digit Decimals' },
      27: { start: 195, end: 206, title: 'Understand Division with Fractions' },
      28: { start: 207, end: 228, title: 'Divide Fractions' },
      29: { start: 229, end: 266, title: 'Solve Volume Problems with Fractions' },
      30: { start: 267, end: 278, title: 'Understand Ratio Concepts' },
      31: { start: 279, end: 306, title: 'Find Equivalent Ratios' },
      32: { start: 307, end: 344, title: 'Use Part-to-Part and Part-to-Whole Ratios' },
      33: { start: 345, end: 356, title: 'Understand Rate Concepts' },
      34: { start: 357, end: 384, title: 'Use Unit Rates to Solve Problems' },
      35: { start: 385, end: 396, title: 'Understand Percents' },
      36: { start: 397, end: 408, title: 'Use Percents to Solve Problems' },
