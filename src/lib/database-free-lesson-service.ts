...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      15: { start: 353, end: 364, title: 'Understand Rate Concepts' },
      16: { start: 365, end: 392, title: 'Use Unit Rates to Solve Problems' },
      17: { start: 393, end: 404, title: 'Understand Percents' },
      18: { start: 405, end: 426, title: 'Use Percents to Solve Problems' },
      19: { start: 443, end: 470, title: 'Write and Identify Equivalent Expressions' },
      20: { start: 471, end: 482, title: 'Understand Solutions of Equations' },
      21: { start: 483, end: 510, title: 'Write and Solve One-Variable Equations' },
      22: { start: 511, end: 532, title: 'Analyze Two-Variable Relationships' },
      23: { start: 549, end: 560, title: 'Understand Positive and Negative Numbers' },
      24: { start: 561, end: 576, title: 'Order Positive and Negative Numbers' },
      25: { start: 577, end: 588, title: 'Understand Absolute Value' },
      26: { start: 589, end: 616, title: 'Write and Graph One-Variable Inequalities' },
      27: { start: 617, end: 628, title: 'Understand the Four-Quadrant Coordinate Plane' },
      28: { start: 629, end: 650, title: 'Solve Problems in the Coordinate Plane' },
      29: { start: 667, end: 678, title: 'Understand Statistical Questions and Data Distributions' },
      30: { start: 679, end: 700, title: 'Use Dot Plots and Histograms to Describe Data Distributions' },
      31: { start: 701, end: 722, title: 'Interpret Median and Interquartile Range in Box Plots' },
      32: { start: 723, end: 744, title: 'Interpret Mean and Mean Absolute Deviation' },
      33: { start: 745, end: 760, title: 'Use Measures of Center and Variability to Summarize Data' },
    },
    'RCM07_NA_SW_V1': {
