...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      15: { start: 357, end: 368, title: 'Understand Rate Concepts' },
      16: { start: 369, end: 396, title: 'Use Unit Rates to Solve Problems' },
      17: { start: 397, end: 408, title: 'Understand Percents' },
      18: { start: 409, end: 430, title: 'Use Percents to Solve Problems' },
      19: { start: 447, end: 474, title: 'Write and Identify Equivalent Expressions' },
      20: { start: 475, end: 486, title: 'Understand Solutions of Equations' },
      21: { start: 487, end: 514, title: 'Write and Solve One-Variable Equations' },
      22: { start: 515, end: 536, title: 'Analyze Two-Variable Relationships' },
      23: { start: 553, end: 564, title: 'Understand Positive and Negative Numbers' },
      24: { start: 565, end: 580, title: 'Order Positive and Negative Numbers' },
      25: { start: 581, end: 592, title: 'Understand Absolute Value' },
      26: { start: 593, end: 620, title: 'Write and Graph One-Variable Inequalities' },
      27: { start: 621, end: 632, title: 'Understand the Four-Quadrant Coordinate Plane' },
      28: { start: 633, end: 654, title: 'Solve Problems in the Coordinate Plane' },
      29: { start: 671, end: 682, title: 'Understand Statistical Questions and Data Distributions' },
      30: { start: 683, end: 704, title: 'Use Dot Plots and Histograms to Describe Data Distributions' },
      31: { start: 705, end: 726, title: 'Interpret Median and Interquartile Range in Box Plots' },
      32: { start: 727, end: 748, title: 'Interpret Mean and Mean Absolute Deviation' },
      33: { start: 749, end: 764, title: 'Use Measures of Center and Variability to Summarize Data' },
    },
    'RCM07_NA_SW_V1': {
