...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    ...
    'RCM06_NA_SW_V2': {
      ...
      22: { start: 159, end: 226, title: 'Analyze Two-Variable Relationships' },
      23: { start: 227, end: 268, title: 'Understand Positive and Negative Numbers' },
      24: { start: 269, end: 313, title: 'Order Positive and Negative Numbers' },
