...
export class DatabaseFreeLessonService {
  ...
  private static lessonBoundaries: Record<string, Record<number, { start: number; end: number; title: string }>> = {
    'RCM06_NA_SW_V1': {
      ...
      6: { start: 119, end: 158, title: 'Find Greatest Common Factor and Least Common Multiple' },
      7: { start: 159, end: 180, title: 'Add, Subtract, and Multiply Multi-Digit Decimals' },
      8: { start: 181, end: 208, title: 'Divide Whole Numbers and Multi-Digit Decimals' },
      9: { start: 209, end: 220, title: 'Understand Division with Fractions' },
      10: { start: 221, end: 242, title: 'Divide Fractions' },
      11: { start: 243, end: 282, title: 'Solve Volume Problems with Fractions' },
      12: { start: 283, end: 294, title: 'Understand Ratio Concepts' },
      13: { start: 295, end: 322, title: 'Find Equivalent Ratios' },
      14: { start: 323, end: 362, title: 'Use Part-to-Part and Part-to-Whole Ratios' },
      15: { start: 363, end: 374, title: 'Understand Rate Concepts' },
      16: { start: 375, end: 402, title: 'Use Unit Rates to Solve Problems' },
      17: { start: 403, end: 414, title: 'Understand Percents' },
      18: { start: 415, end: 450, title: 'Use Percents to Solve Problems' },
    },
    'RCM06_NA_SW_V2': {
      19: { start: 17, end: 46, title: 'Write and Identify Equivalent Expressions' },
      20: { start: 47, end: 54, title: 'Understand Solutions of Equations' },
      21: { start: 55, end: 82, title: 'Write and Solve One-Variable Equations' },
      22: { start: 83, end: 122, title: 'Analyze Two-Variable Relationships' },
      23: { start: 123, end: 134, title: 'Understand Positive and Negative Numbers' },
      24: { start: 135, end: 150, title: 'Order Positive and Negative Numbers' },
      25: { start: 151, end: 162, title: 'Understand Absolute Value' },
      26: { start: 163, end: 190, title: 'Write and Graph One-Variable Inequalities' },
      27: { start: 191, end: 202, title: 'Understand the Four-Quadrant Coordinate Plane' },
      28: { start: 203, end: 242, title: 'Solve Problems in the Coordinate Plane' },
      ...
      33: { start: 321, end: 350, title: 'Use Measures of Center and Variability to Summarize Data' },
