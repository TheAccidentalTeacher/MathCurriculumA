...
export default async function Algebra1Volume2ViewerPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      />
      <Script id="pdfjsWorker-alg1v2" strategy="beforeInteractive">
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="bg-white border-b border-gray-200 px-4 py-3">
          <h1 className="text-xl font-semibold text-gray-900">
            Algebra 1 Mathematics - Volume 2
          </h1>
        </div>
        
        <Suspense fallback={<div className="p-8">Loading...</div>}>
          <PageViewer 
            documentId="ALG01_NA_SW_V2"
            totalPages={698}
            initialPage={initialPage}
            volumeName="Algebra 1 - Volume 2"
            volume="algebra1-volume2"
