...
export default async function Grade8Volume1ViewerPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      />
      <Script id="pdfjsWorker-g8v1" strategy="beforeInteractive">
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <Suspense fallback={<div className="p-8">Loading...</div>}>
          <PageViewer 
            ...
            volumeName="Grade 8 - Volume 1"
            volume="grade8-volume1"
