...
export default async function Grade8Volume2ViewerPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      />
      <Script id="pdfjsWorker-g8v2" strategy="beforeInteractive">
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="bg-white border-b border-gray-200 px-4 py-3">
          <h1 className="text-xl font-semibold text-gray-900">
            Grade 8 Mathematics - Volume 2
          </h1>
        </div>
        
        <Suspense fallback={<div className="p-8">Loading...</div>}>
          <PageViewer 
            documentId="RCM08_NA_SW_V2"
            totalPages={440}
            initialPage={initialPage}
            volumeName="Grade 8 - Volume 2"
            volume="grade8-volume2"
